...
int ny = 70;                //lattice size y
int nz = 70;                //lattice size z (only for 3D code)
...
double body_force = 1.0e-4; //gravity force
...
double rho_boundary = 0.28; //define density of solid walls
double top_wall_speed = 0.0;//speed of top wall for lid driven cavity
double bot_wall_speed = 0.0;//speed of bottom wall
int d1r = 18;               //droplet1 radius
int d1x = 25;               //droplet1 position x (for multiphase model)
int d1y = 0;                //droplet1 position y (for multiphase model)
int d1z = 35;               //droplet1 position z (for multiphase model)
int drop1 = 1.0;            //1=droplet, -1=buble
int d2r = 15;               //droplet2 radius
int d2x = 45;               //droplet2 position x (for multiphase model)
int d2y = 50;               //droplet2 position y (for multiphase model)
int d2z = 35;               //droplet2 position z (for multiphase model)
